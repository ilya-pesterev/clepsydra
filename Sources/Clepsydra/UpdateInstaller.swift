...
/// весь этот интерфейс здесь заменён молчанием: обновление не заговаривает
/// первым — ни окном, ни уведомлением (ADR-0009, ADR-0010; про второй голос,
/// который выдан не ему, — ADR-0014).
