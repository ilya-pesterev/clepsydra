...
func checkReminder(_ t: Runner) {
    ...
    t.test("Галочка стоит ровно тогда, когда напоминание говорит") {
        // `isOn` спрашивают оба: и пункт меню — рисовать ли галочку, и голос —
        // окликать ли. Разойдись они, галочка встала бы над молчанием.
        t.expect(ReminderLabel.isOn(.silenced), false,
                 "запрещённое напоминание не говорит и галочки не получает")
