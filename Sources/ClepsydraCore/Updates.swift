...
/// пропускает: сегодня их некому показать, а страницу релиза человек открывает
/// целиком. Отвергать из-за них фид тем более нельзя — установленной копии
/// чинить его нечем.
///
...
public enum UpdateFeed {
    ...
    /// Страница последнего релиза — туда ведёт пункт «Обновить».
